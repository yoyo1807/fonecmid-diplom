...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	ИнтеграцияПодсистемБСП.ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления);
	
	УправлениеДоступомИТ.ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления); 
	
		// 1. Профиль: Кадровик-Расчетчик
	Описание = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	Описание.Имя = "ВКМ_КадровикРасчетчик";
	Описание.Наименование = "Кадровик-Расчетчик (ВКМ)";
	Описание.Идентификатор = "7a40b1e0-4768-4e5a-96e5-1815d2a6a1a1";
	Описание.Роли.Добавить("ВКМ_КадровикРасчетчик");
	Описание.Роли.Добавить("ВКМ_ОсновнаяСправочники"); 
	Описание.Роли.Добавить("БазовыеПраваБСП");
	Описание.Роли.Добавить("ЗапускТонкогоКлиента");     
	Описание.Роли.Добавить("ЗапускВебКлиента"); 
	Описание.Роли.Добавить("ЧтениеНСИ");

	ОписанияПрофилей.Добавить(Описание);

	// 2. Профиль: Специалист
	Описание = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа(); 
	Описание.Имя = "ВКМ_Специалист";
	Описание.Наименование = "Специалист (ВКМ)";
	Описание.Идентификатор = "c2b3e4f5-1234-4a4b-8c8d-9e9f0a0b1c1c";
	Описание.Роли.Добавить("ВКМ_РаботаСОбслуживанием");
	Описание.Роли.Добавить("ВКМ_ОсновнаяСправочники"); 
	Описание.Роли.Добавить("ВКМ_Менеджер");  
	Описание.Роли.Добавить("БазовыеПраваБСП");
	Описание.Роли.Добавить("ЗапускТонкогоКлиента");     
	Описание.Роли.Добавить("ЗапускВебКлиента"); 
	Описание.Роли.Добавить("ЧтениеНСИ");
	...
	// 3. Профиль: Менеджер
	Описание = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа(); 
	Описание.Имя = "ВКМ_Менеджер";
	Описание.Наименование = "Менеджер (ВКМ)";
	Описание.Идентификатор = "d8e7f6a5-5678-4b4c-adad-1234567890ab";
	Описание.Роли.Добавить("ВКМ_Менеджер");
	Описание.Роли.Добавить("ВКМ_ОсновнаяСправочники");
	Описание.Роли.Добавить("БазовыеПраваБСП");
	Описание.Роли.Добавить("ЗапускТонкогоКлиента");     
	...
	// 4. Профиль: Бухгалтер
	Описание = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	Описание.Имя = "ВКМ_БухгалтерИТ";
	Описание.Наименование = "Бухгалтер (ВКМ)";
	Описание.Идентификатор = "f1e2d3c4-b9b8-4747-a1a1-000000000001";
	Описание.Роли.Добавить("ВКМ_БухгалтерИТ");
	Описание.Роли.Добавить("ВКМ_ОсновнаяСправочники");
	Описание.Роли.Добавить("БазовыеПраваБСП");
	Описание.Роли.Добавить("ЗапускТонкогоКлиента");     
	Описание.Роли.Добавить("ЗапускВебКлиента"); 
